...
public final class JtelayoutGenerated {
	...
	public static final int[] JTE_LINE_INFO = {0,0,1,1,1,1,10,10,10,10,79,79,80,80,80,82,82,85,85,92,92,92,97,97,97,1,2,3,3,3,3};
	public static void render(gg.jte.html.HtmlTemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, String title, gg.jte.Content content, String currentUser) {
		...
		jteOutput.writeContent("</title>\n    <link href=\"https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css\" rel=\"stylesheet\">\n    <link href=\"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css\" rel=\"stylesheet\">\n    <style>\n        body {\n            background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);\n            min-height: 100vh;\n            font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;\n        }\n        .main-container {\n            min-height: 100vh;\n            display: flex;\n            align-items: center;\n            justify-content: center;\n            padding: 20px;\n        }\n        .card {\n            backdrop-filter: blur(10px);\n            background: rgba(255, 255, 255, 0.95);\n            border: none;\n            border-radius: 20px;\n            box-shadow: 0 20px 40px rgba(0, 0, 0, 0.1);\n        }\n        .navbar-brand {\n            font-weight: 600;\n            color: #fff !important;\n        }\n        .btn-primary {\n            background: linear-gradient(45deg, #667eea, #764ba2);\n            border: none;\n            border-radius: 10px;\n            padding: 12px 30px;\n            font-weight: 500;\n            transition: all 0.3s ease;\n        }\n        .btn-primary:hover {\n            transform: translateY(-2px);\n            box-shadow: 0 10px 20px rgba(102, 126, 234, 0.4);\n        }\n        .form-control {\n            border-radius: 10px;\n            border: 2px solid #e0e0e0;\n            padding: 12px 15px;\n            transition: all 0.3s ease;\n        }\n        .form-control:focus {\n            border-color: #667eea;\n            box-shadow: 0 0 0 0.2rem rgba(102, 126, 234, 0.25);\n        }\n        .alert {\n            border-radius: 10px;\n            border: none;\n        }\n    </style>\n</head>\n<body>\n<nav class=\"navbar navbar-expand-lg navbar-dark\" style=\"background: rgba(0,0,0,0.1);\">\n    <div class=\"container\">\n        <a class=\"navbar-brand\" href=\"/\">\n            <i class=\"fas fa-book me-2\"></i>\n            Library Management System\n        </a>\n        <button class=\"navbar-toggler\" type=\"button\" data-bs-toggle=\"collapse\" data-bs-target=\"#navbarNav\">\n            <span class=\"navbar-toggler-icon\"></span>\n        </button>\n        <div class=\"collapse navbar-collapse\" id=\"navbarNav\">\n            <div class=\"navbar-nav ms-auto\">\n                <a class=\"nav-link\" href=\"/\"><i class=\"fas fa-home me-1\"></i>Головна</a>\n\n                ");
		if (currentUser != null) {
			jteOutput.writeContent("\n                    <span class=\"nav-link\" style=\"color: white;\"><i class=\"fas fa-user me-1\"></i>Вітаємо, ");
			jteOutput.setContext("span", null);
			jteOutput.writeUserContent(currentUser);
			jteOutput.writeContent("!</span>\n                    <a class=\"nav-link\" href=\"/logout\"><i class=\"fas fa-sign-out-alt me-1\"></i>Вихід</a>\n                ");
		} else {
			jteOutput.writeContent("\n                    <a class=\"nav-link\" href=\"/login\"><i class=\"fas fa-sign-in-alt me-1\"></i>Вхід</a>\n                    <a class=\"nav-link\" href=\"/register\"><i class=\"fas fa-user-plus me-1\"></i>Реєстрація</a>\n                ");
		}
